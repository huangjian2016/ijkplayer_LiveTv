 ...
 */
package com.example.huangjian.livetv_ijkplayer.ijkplayer;
...
public class Settings {
    ...
    public int getPlayer() {
        ...
        String value = mSharedPreferences.getString(key, "2"); //huangjian choose ijkplayer
        try {
            return Integer.valueOf(value).intValue();
        } catch (NumberFormatException e) {
            //return 0;
            return 2; //huangjian choose ijkplayer
        }
    }
